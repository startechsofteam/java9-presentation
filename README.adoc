...
Parmi les nombreuses reproches qu'on fait à Java, c'est qu'il est super verbeux.
...
Merci Guava ! Il a fallu attendre Java 9 pour avoir çà :
[source,java]
----
...
----
Pour résumer on peut déclarer une collection inmodifiable, dans laquelle on peut initialiser quelques élements.
ATTENTION :
